...
export default {
  ...
  methods: {
    ...
    drop: function (params, $event) {
      ...
      switch (module) {
        ...
        case this.module.detailed.type:
          ...
          // 测试用默认数据
          let x = '[[[{"type":"inputNumber","id":"inputNumber-1531128984705-77","value":null,"require":false,"name":"inputNumber1531128984705","title":"数字输入框","label":"（明细）数字输入框","tips":"","max":20000,"min":0},{"type":"count","id":"count-1531128986111-78","value":null,"require":false,"name":"count1531128986111","title":"计算公式","label":"（明细）计算公式","tips":"","validFormulas":" ","nowFormulas":"计算公式 = ","tempFormulas":"","countFormulas":"","tempCountFormulas":"","formulasValid":true,"resultTips":"大写：","unit":"","cnNum":"","showUpper":true},{"type":"money","id":"money-1531128995279-85","value":null,"require":false,"name":"money1531128995279","title":"金额","label":"（明细）金额","tips":"","max":100000,"min":0,"resultTips":"大写：","unit":"","cnNum":"","showUpper":true}]]]';
    ...
    countModuelsNum: function (params) {
      ...
      return params.title + (this.modulesIndex[params.type] === 0 ? "" :
    ...
    editFormElement: function (params) {
      ...
      if(module.type === this.module.radio.type || module.type === this.module.checkbox.type ||
        ...
        if (result) {
          for (const key in this.moduleConfig) {
            if (this.moduleConfig.hasOwnProperty(key)) {
              if(key === "require" || key === "tips" || this.modulesData[row][col][m][key] !== undefined){
                // 更新表单组件数据
    ...
    delModule: function (params) {
      ...
      if (this.modulesLength[params.module.type] > -1) {
        this.modulesLength[params.module.type] = this.modulesLength[params.module.type] - 1;
      }
